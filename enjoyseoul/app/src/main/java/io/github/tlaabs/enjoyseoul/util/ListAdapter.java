...
public class ListAdapter extends RecyclerView.Adapter<ListViewHolder> {
    ...
    public ListAdapter(Context context, HashMap<String, Integer> genreColorMap) {
    ...
    public ListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(
                parent.getContext()).inflate(R.layout.event_item, parent, false
        );
    ...
    private class GetRatingTask extends AsyncTask<Integer, Integer, String> {
        ...
        public GetRatingTask(int position, ListViewHolder holder) {
